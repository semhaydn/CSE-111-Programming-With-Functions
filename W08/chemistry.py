...
def main():
    ...
    compound_list = parse_formula(formula, periodic_table_dict)

    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list and
    # the periodic table dictionary.
    total_molar_mass = compute_molar_mass(compound_list, periodic_table_dict)

    # Compute the number of moles in the sample.
    moles = mass / total_molar_mass

    # Print the molar mass.
    print(f'Molar Mass: {total_molar_mass:.5f}  grams/mole')

    # Print the number of moles.
    print(f'Number of Moles: {moles:.5f} moles')

    # Call the get_formula_name function to get the compound name.
